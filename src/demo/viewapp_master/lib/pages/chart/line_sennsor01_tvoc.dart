...
class _LineViewtvocState extends State<LineViewtvoc> {
  ...
  Future<List<dynamic>?> getData2() async {
    ...
    final String? serverSource =
        await PreferencesUtil.getString("serverSource");
    final Uri uri = Uri.http(serverSource!, "/read/$setboards/tvoc");
    final response = await http.get(uri);
    final result = response.body;
  ...
  Widget build(BuildContext context) {
    ...
    final doubleValue0 = data2?[0]["tvoc"]?.toDouble() ?? 0.0;
    final doubleValue1 = data2?[1]["tvoc"]?.toDouble() ?? 0.0;
    final doubleValue2 = data2?[2]["tvoc"]?.toDouble() ?? 0.0;
    final doubleValue3 = data2?[3]["tvoc"]?.toDouble() ?? 0.0;
    final doubleValue4 = data2?[4]["tvoc"]?.toDouble() ?? 0.0;
    final doubleValue5 = data2?[5]["tvoc"]?.toDouble() ?? 0.0;
    final doubleValue6 = data2?[6]["tvoc"]?.toDouble() ?? 0.0;
    final doubleValue7 = data2?[7]["tvoc"]?.toDouble() ?? 0.0;
    List<double> yValues = [
      doubleValue0,
      doubleValue1,
      doubleValue2,
